...
#' @seealso \code{\link{plot.split.3d}} \code{\link{get.synapses}}
...
#' @export
#' @rdname plot.split.3d
#' @seealso \code{\link{flow.centrality}} \code{\link{get.synapses}}
plot.split.3d = function(someneuronlist, col = c("blue", "orange", "purple","green","pink"), WithConnectors = T, WithNodes = F, soma = 100, highflow = F){
