...
- Be aware that the importing will take connectors with your neuron, but in FIXME `v14-seg` it will create new connectors, that will not retain any other connectivity information other than their relationship with the imported skeleton.
